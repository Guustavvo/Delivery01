...
categoria.engine("handlebars", expressHandlebars.engine())
categoria.set("view engine", "handlebars")
        ...
        if(erro){
            ...
            database.all(`select * from categoria`, function(erro, categoria){
                if(erro){
                    ...
                    res.render("categoriasAdmin", {categoria, admin})
                }
            })
        }
    })
